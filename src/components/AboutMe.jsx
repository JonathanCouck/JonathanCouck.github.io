  ...
  return (
    <section id='aboutMe'>
      ...
      <div className='flex flex-col md:grid md:grid-rows-auto md:grid-cols-[auto] gap-10 text-justify m-12 md:mx-20'>
        <div className='text-big col-start-1'>
          <p>Hello there!</p>
          <p>My name is Jonathan Couck, and I'm pleased to welcome you to my very own portfolio-website!</p>
        </div>
        <div className='text-small row-start-3 md:row-start-1 md:col-start-2 md:col-span-2 h-min'>
        ...
        <button onClick={onBtnClick} className='text-small nav-style mx-auto col-span-3 bg-secondary rounded-full border-2 border-text px-4 py-2'>
          Download my resume
        </button>
      </div>
    </section>
